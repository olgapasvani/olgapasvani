...
public:
    ...
    //Constructors
    Secretary(){
        Person *persPtr = new Person();
        PeopleData.push_back(persPtr);
    }
...
istream &operator>>(istream &str, Secretary &obj){
    string stop;
    do{
        cout <<"Enter a person's data"<<endl;
...
int main(){
    ...
    cout << obj3;
    cout << "Enter an academic ID to check if the person who has it belongs in the class"<<endl;
